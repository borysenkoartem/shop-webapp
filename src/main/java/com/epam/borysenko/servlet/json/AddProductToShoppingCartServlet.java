...
@WebServlet("/json/product/add")
public class AddProductToShoppingCartServlet extends AbstractServlet {

    private static final Logger ADD_PRODUCT_SERVLET_LOGGER = LoggerFactory.getLogger(AddProductToShoppingCartServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            ADD_PRODUCT_SERVLET_LOGGER.error(e.getMessage());
        }
